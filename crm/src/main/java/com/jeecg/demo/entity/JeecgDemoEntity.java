...
public class JeecgDemoEntity implements java.io.Serializable
{
	...
	/** 名称 */
	@Excel(name = "名称", width = 32) private java.lang.String name;

	/** 年龄 */
	@Excel(name = "年龄") private java.lang.Integer age;

	/** 生日 */
	@Excel(name = "生日", format = "yyyy-MM-dd") private java.util.Date birthday;

	/** 个人介绍 */
	@Excel(name = "个人介绍") private java.lang.String content;

	/** 部门 */
	@Excel(name = "部门") private java.lang.String depId;

	/** 邮箱 */
	@Excel(name = "邮箱", width = 32) private java.lang.String email;

	/** 电话 */
	@Excel(name = "电话", width = 12) private java.lang.String phone;

	/** 工资 */
	@Excel(name = "工资") private java.lang.String salary;

	/** 性别 */
	@Excel(name = "性别") private java.lang.String sex;

	/** 入职状态 */
	@Excel(name = "入职状态") private java.lang.String status;
	...
	/** 组织 */
	@Excel(name = "部门编码", width = 200) private java.lang.String sysOrgCode;
