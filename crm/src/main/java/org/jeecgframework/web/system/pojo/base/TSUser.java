...
public class TSUser extends TSBaseUser implements java.io.Serializable
{
	...
	@Excel(name = "手机") private String mobilePhone;// 手机

	@Excel(name = "办公电话") private String officePhone;// 办公电话

	@Excel(name = "邮箱") private String email;// 邮箱
