...
public abstract class GenericBaseCommonDao<T, PK extends Serializable> implements IGenericBaseCommonDao
{
	...
	public <T> Serializable save(T entity)
	{
		...
		try
		{
			value = entity.getClass().getMethod("getId").invoke(entity);
			try
			{
	...
	@Autowired @Qualifier("namedParameterJdbcTemplate") private NamedParameterJdbcTemplate namedParameterJdbcTemplate;
