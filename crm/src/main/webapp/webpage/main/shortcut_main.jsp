...
<tr>
    ...
    <h1 style="font-size: 35px;margin-left: 15px;" >CRM客户管理系统</h1>
    </td>
            ...
            <tr style="height: 25px;" align="right">
                <td style="" colspan="2">
                    ...
                    <div style="float: left; line-height: 25px; margin-left: 70px;">
                        ...
                        <span style="color: #FFFFFF">${currentOrgName}</span><c:if test="${orgCode!=null&&orgCode!=''}">--<span style="color: #FFFFFF">${orgCode}</span></c:if>
...
<div collapsed="true" region="east" iconCls="icon-reload" title="<t:mutiLang langKey="common.assist.tools"/>" split="true" style="width: 190px;"
    ...
    -->
    <div class="easyui-layout" fit="true" border="false" style="display: none;" >
